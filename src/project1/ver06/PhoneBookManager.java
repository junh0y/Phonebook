...
{
	public project1.ver06.PhoneInfo[] friends;
	public int index;
	
	public PhoneBookManager(int num)
	{
		friends = new project1.ver06.PhoneInfo[num];
		index = 0;
	}
	...
	public void dataInput()
	{
		...
		switch (select)
		{
			case general :
			{
				...
				project1.ver06.PhoneInfo friend
					= new project1.ver06.PhoneInfo(name, phoneNumber);
